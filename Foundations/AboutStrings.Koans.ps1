...
Describe 'Strings' {
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can do a simple expansion' {
            'Your home directory is located here: C:\Users\Patrick' | Should -Be "Your home directory is located here: $HOME"
        }
        ...
        It 'handles other ways of doing the same thing' {
            ...
            'Your home folder is: C:\Users\Patrick' | Should -Be $String
        }
